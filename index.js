...
function extendAndFreezeObject(obj1, obj2) {
  ...
  const asignObj = Object.assign(obj1, obj2);
  const freezeObj = Object.freeze(asignObj);

  if (Object.isFrozen(freezeObj)) {
    return freezeObj;
  } else {
    return "Object is not freezen";
  }
...
function getObjectValuesSum(obj) {
  ...
  const sum = valueObj.reduce((previousValue, currentValue) => {
